...
bigger, we see that power increases as well (and appears to max/plateau
around a mean of 5).
...
approximately equal to the true value of μ (and the error variance is
lower) **as the effect size increases**.
